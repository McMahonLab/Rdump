...
#export 5x7.5 pdf
ggplot(data=TB_all_2018, aes(x=Turbidity,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Trout Bog Turbidity Profiles") + labs(x="Turbidity(FNU)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.8,.4))
ggplot(data=TB_all_2018, aes(x=ORP,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Trout Bog ORP Profiles") + labs(x="ORP(mV)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.8,.3))
ggplot(data=TB_all_2018, aes(x=Temp,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Trout Bog Temperature Profiles") + labs(x="Temperature(F)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.6,.4))
ggplot(data=TB_all_2018, aes(x=ODO.1,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Trout Bog ODO Profiles") + labs(x="ODO(mg/L)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.6,.4))
ggplot(data=TB_all_2018, aes(x=pH,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Trout Bog pH Profiles") + labs(x="pH",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.7,.4))
...
TB_all_2018 <- TB_all_2018[which(TB_all_2018$pH < 5.2), ]
#export 5x7.5 pdf
ggplot(data=TB_all_2018, aes(x=Turbidity,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Trout Bog Turbidity Profiles") + labs(x="Turbidity(FNU)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.7,.4))
ggplot(data=TB_all_2018, aes(x=ORP,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Trout Bog ORP Profiles") + labs(x="ORP(mV)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.8,.3))
ggplot(data=TB_all_2018, aes(x=Temp,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Trout Bog Temperature Profiles") + labs(x="Temperature(F)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.6,.4))
ggplot(data=TB_all_2018, aes(x=ODO.1,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Trout Bog ODO Profiles") + labs(x="ODO(mg/L)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.6,.4))
ggplot(data=TB_all_2018, aes(x=pH,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Trout Bog pH Profiles") + labs(x="pH",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.7,.4))
...
#export 5x7.5 pdf
ggplot(data=TB_all_2019, aes(x=Turbidity,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Trout Bog Turbidity Profiles") + labs(x="Turbidity(FNU)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.8,.4))
ggplot(data=TB_all_2019, aes(x=ORP,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Trout Bog ORP Profiles") + labs(x="ORP(mV)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.8,.3))
ggplot(data=TB_all_2019, aes(x=Temp,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Trout Bog Temperature Profiles") + labs(x="Temperature(F)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.6,.4))
ggplot(data=TB_all_2019, aes(x=ODO.1,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Trout Bog ODO Profiles") + labs(x="ODO(mg/L)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.6,.4))
ggplot(data=TB_all_2019, aes(x=pH,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Trout Bog pH Profiles") + labs(x="pH",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.75,.4))
...
#export 5x7.5 pdf
ggplot(data=SS_all_2018, aes(x=Turbidity,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("South Sparkling Bog Turbidity Profiles") + labs(x="Turbidity(FNU)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.8,.4))
ggplot(data=SS_all_2018, aes(x=ORP,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("South Sparkling ORP Profiles") + labs(x="ORP(mV)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.8,.3))
ggplot(data=SS_all_2018, aes(x=Temp,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("South Sparkling Bog Temperature Profiles") + labs(x="Temperature(F)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.6,.4))
ggplot(data=SS_all_2018, aes(x=ODO.1,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("South Sparkling Bog ODO Profiles") + labs(x="ODO(mg/L)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.6,.4))
ggplot(data=SS_all_2018, aes(x=pH,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("South Sparkling Bog pH Profiles") + labs(x="pH",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.6,.4))

ggplot(data=SS_all_2019, aes(x=Turbidity,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("South Sparkling Bog Turbidity Profiles") + labs(x="Turbidity(FNU)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.7,.4))
ggplot(data=SS_all_2019, aes(x=ORP,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("South Sparkling ORP Profiles") + labs(x="ORP(mV)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.8,.3))
ggplot(data=SS_all_2019, aes(x=Temp,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("South Sparkling Bog Temperature Profiles") + labs(x="Temperature(F)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.6,.4))
ggplot(data=SS_all_2019, aes(x=ODO.1,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("South Sparkling Bog ODO Profiles") + labs(x="ODO(mg/L)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.6,.4))
ggplot(data=SS_all_2019, aes(x=pH,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("South Sparkling Bog pH Profiles") + labs(x="pH",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.75,.4))
...
#export 5x7.5 pdf
ggplot(data=NS_all_2018, aes(x=Turbidity,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("North Sparkling Bog Turbidity Profiles") + labs(x="Turbidity(FNU)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.7,.8))
ggplot(data=NS_all_2018, aes(x=ORP,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("North Sparkling ORP Profiles") + labs(x="ORP(mV)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.8,.3))
ggplot(data=NS_all_2018, aes(x=Temp,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("North Sparkling Bog Temperature Profiles") + labs(x="Temperature(F)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.6,.4))
ggplot(data=NS_all_2018, aes(x=ODO.1,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("North Sparkling Bog ODO Profiles") + labs(x="ODO(mg/L)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.6,.4))
ggplot(data=NS_all_2018, aes(x=pH,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("North Sparkling Bog pH Profiles") + labs(x="pH",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.6,.4))

ggplot(data=NS_all_2019, aes(x=Turbidity,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("North Sparkling Bog Turbidity Profiles") + labs(x="Turbidity(FNU)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.7,.76))
ggplot(data=NS_all_2019, aes(x=ORP,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("North Sparkling ORP Profiles") + labs(x="ORP(mV)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.3,.7))
ggplot(data=NS_all_2019, aes(x=Temp,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("North Sparkling Bog Temperature Profiles") + labs(x="Temperature(F)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.6,.4))
ggplot(data=NS_all_2019, aes(x=ODO.1,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("North Sparkling Bog ODO Profiles") + labs(x="ODO(mg/L)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.6,.4))
ggplot(data=NS_all_2019, aes(x=pH,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("North Sparkling Bog pH Profiles") + labs(x="pH",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.75,.78))

#Plotting Mary Lake
ML_all_2018 <- rbind(ML_2019_07_03, ML_2018_07_12, ML_2018_07_19, ML_2018_08_06, ML_2018_08_10)
...
#export 5x7.5 pdf
ggplot(data=ML_all_2018, aes(x=Turbidity,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Mary Lake Turbidity Profiles") + labs(x="Turbidity(FNU)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.7,.8))
ggplot(data=ML_all_2018, aes(x=ORP,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Mary Lake ORP Profiles") + labs(x="ORP(mV)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.8,.3))
ggplot(data=ML_all_2018, aes(x=Temp,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Mary Lake Temperature Profiles") + labs(x="Temperature(F)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.6,.4))
ggplot(data=ML_all_2018, aes(x=ODO.1,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Mary Lake ODO Profiles") + labs(x="ODO(mg/L)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.6,.4))
ggplot(data=ML_all_2018, aes(x=pH,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Mary Lake pH Profiles") + labs(x="pH",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.6,.4))
#Adjust averages of Turb 10 to 11 deep to be 2.05 fnu
ggplot(data=ML_all_2019, aes(x=Turbidity,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Mary Lake Turbidity Profiles") + labs(x="Turbidity(FNU)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.6,.6))
ggplot(data=ML_all_2019, aes(x=ORP,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Mary Lake ORP Profiles") + labs(x="ORP(mV)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.5,.3))
ggplot(data=ML_all_2019, aes(x=Temp,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Mary Lake Temperature Profiles") + labs(x="Temperature(F)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.4,.4))
ggplot(data=ML_all_2019, aes(x=ODO.1,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Mary Lake ODO Profiles") + labs(x="ODO(mg/L)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.4,.4))
ggplot(data=ML_all_2019, aes(x=pH,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Mary Lake pH Profiles") + labs(x="pH",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.6,.4))
...
#export 5x7.5 pdf
ggplot(data=CB_all_2018, aes(x=Turbidity,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Crystal Bog Turbidity Profiles") + labs(x="Turbidity(FNU)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.7,.8))
ggplot(data=CB_all_2018, aes(x=ORP,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Crystal Bog ORP Profiles") + labs(x="ORP(mV)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.8,.3))
ggplot(data=CB_all_2018, aes(x=Temp,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Crystal Bog Temperature Profiles") + labs(x="Temperature(F)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.6,.4))
ggplot(data=CB_all_2018, aes(x=ODO.1,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Crystal Bog ODO Profiles") + labs(x="ODO(mg/L)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.6,.4))
ggplot(data=CB_all_2018, aes(x=pH,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Crystal Bog pH Profiles") + labs(x="pH",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.6,.4))
#2019
ggplot(data=CB_all_2019, aes(x=Turbidity,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Crystal Bog Turbidity Profiles") + labs(x="Turbidity(FNU)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.6,.5))
ggplot(data=CB_all_2019, aes(x=ORP,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Crystal Bog ORP Profiles") + labs(x="ORP(mV)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.1,.5))
ggplot(data=CB_all_2019, aes(x=Temp,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Crystal Bog Temperature Profiles") + labs(x="Temperature(F)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.7,.2))
ggplot(data=CB_all_2019, aes(x=ODO.1,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Crystal Bog ODO Profiles") + labs(x="ODO(mg/L)",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.6,.3))
ggplot(data=CB_all_2019, aes(x=pH,y=Depth, group = DATE, color=DATE)) + geom_point() + scale_y_reverse() + geom_path() + ggtitle("Crystal Bog pH Profiles") + labs(x="pH",y='Depth(m)') + scale_color_grey(start=.8,end=.1) + theme(legend.position=c(.5,.4))
