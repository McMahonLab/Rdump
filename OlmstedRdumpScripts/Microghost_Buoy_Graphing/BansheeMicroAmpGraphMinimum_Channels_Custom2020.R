...
HOBO <- HOBO[,c(1,2,3)]
metadata <- read.csv(file="metadata_2020_Microgeists.csv")
#metadata wrong, idk why look at notes.
...
#removing membrane channels and other unwanted channels, desired: Ch1,2,4,8,9,11,14,15,16
geist <- geist[,c(1,2,3,5,9,10,12,13,15,16,17)]
...
ggsave(filename = "Microgeist_Graphs/BanCus_2019-08-04_to_2019-08-06", plot = last_plot(), device = "pdf", width = 13, height = 7.5, units = "in")
