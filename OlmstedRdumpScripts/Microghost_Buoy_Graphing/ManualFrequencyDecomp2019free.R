...
TotInt <- interval(ymd("2019-07-21"), ymd("2019-08-13"))
BetInt <- interval(ymd("2019-07-31"), ymd("2019-08-13")) #after separating touching cathodes

# Now trying on my own data:
#focusing first on 2020 dataset Ch16

setwd("/Users/cnolmsted/Documents/R_scripts/Microgeist_Loggers")
geist <- read.csv(file="Banshee_averaged_YYYYMMDDHHMM.csv", header=T)
#geist <- read.csv(file="Specter_averaged_YYYYMMDDHHMM.csv", header=T)
...
plot(geist$date_time_lubridate,geist$ch1)
...
geistOG <- geist
geist <- geistOG[which(geistOG$date_time_lubridate %within% BetInt == TRUE), ]
Rollgeist <- geist
...
#looking at subsets:
int <- interval(ymd("2019-07-31"), ymd("2019-08-03"))
...
DO70cmTemp70cm <- DOdata[,c(5,3,2)]
colnames(DO70cmTemp70cm)
colnames(DO70cmTemp70cm) <- c("date_time_lubridate","DO_70cm","Temp_70cm")
...
#write.csv(HoboCloudless,"/Users/cnolmsted/Documents/R_scripts/Microgeist_Loggers/FrequencyDecompositionAndSynchrony/2019Cloudless.csv")
#edited Cloudless.csv
Sunsim <- read.csv(file="/Users/cnolmsted/Documents/R_scripts/Microgeist_Loggers/FrequencyDecompositionAndSynchrony/2019Cloudless.csv", header=T)
Sunsim <- Sunsim[,c(2:4)]
...
AmpLuxDOTemp <- merge(AmpLux,DO70cmTemp70cm, by="date_time_lubridate", all=TRUE)

#grabbing nearest values to fill in NAs in AmpLuxDOTemp using the f1 function
colnames(AmpLuxDOTemp)
...
FirstThird <- AmpLuxDOTemp[c(1:305),]
MiddleThird <- AmpLuxDOTemp[c(306:610),]
LastThird <- AmpLuxDOTemp[c(611:915),]
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch1","DO_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch1, AmpLuxDOTemp$DO_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch1, AmpLuxDOTemp$DO_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch1, AmpLuxDOTemp$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch1","Temp_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch1, AmpLuxDOTemp$Temp_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch1, AmpLuxDOTemp$Temp_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch1, AmpLuxDOTemp$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch2","DO_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch2, AmpLuxDOTemp$DO_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch2, AmpLuxDOTemp$DO_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch2, AmpLuxDOTemp$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch2","Temp_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch2, AmpLuxDOTemp$Temp_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch2, AmpLuxDOTemp$Temp_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch2, AmpLuxDOTemp$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch3","DO_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch3, AmpLuxDOTemp$DO_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch3, AmpLuxDOTemp$DO_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch3, AmpLuxDOTemp$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch3","Temp_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch3, AmpLuxDOTemp$Temp_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch3, AmpLuxDOTemp$Temp_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch3, AmpLuxDOTemp$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch4","DO_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch4, AmpLuxDOTemp$DO_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch4, AmpLuxDOTemp$DO_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch4, AmpLuxDOTemp$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch4","Temp_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch4, AmpLuxDOTemp$Temp_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch4, AmpLuxDOTemp$Temp_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch4, AmpLuxDOTemp$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch5","DO_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch5, AmpLuxDOTemp$DO_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch5, AmpLuxDOTemp$DO_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch5, AmpLuxDOTemp$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch5","Temp_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch5, AmpLuxDOTemp$Temp_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch5, AmpLuxDOTemp$Temp_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch5, AmpLuxDOTemp$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch6","DO_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch6, AmpLuxDOTemp$DO_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch6, AmpLuxDOTemp$DO_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch6, AmpLuxDOTemp$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch6","Temp_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch6, AmpLuxDOTemp$Temp_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch6, AmpLuxDOTemp$Temp_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch6, AmpLuxDOTemp$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch7","DO_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch7, AmpLuxDOTemp$DO_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch7, AmpLuxDOTemp$DO_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch7, AmpLuxDOTemp$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch7","Temp_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch7, AmpLuxDOTemp$Temp_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch7, AmpLuxDOTemp$Temp_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch7, AmpLuxDOTemp$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch8","DO_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch8, AmpLuxDOTemp$DO_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch8, AmpLuxDOTemp$DO_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch8, AmpLuxDOTemp$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch8","Temp_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch8, AmpLuxDOTemp$Temp_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch8, AmpLuxDOTemp$Temp_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch8, AmpLuxDOTemp$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch9","DO_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch9, AmpLuxDOTemp$DO_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch9, AmpLuxDOTemp$DO_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch9, AmpLuxDOTemp$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch9","Temp_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch9, AmpLuxDOTemp$Temp_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch9, AmpLuxDOTemp$Temp_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch9, AmpLuxDOTemp$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch10","DO_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch10, AmpLuxDOTemp$DO_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch10, AmpLuxDOTemp$DO_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch10, AmpLuxDOTemp$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch10","Temp_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch10, AmpLuxDOTemp$Temp_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch10, AmpLuxDOTemp$Temp_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch10, AmpLuxDOTemp$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch11","DO_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch11, AmpLuxDOTemp$DO_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch11, AmpLuxDOTemp$DO_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch11, AmpLuxDOTemp$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch11","Temp_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch11, AmpLuxDOTemp$Temp_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch11, AmpLuxDOTemp$Temp_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch11, AmpLuxDOTemp$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch12","DO_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch12, AmpLuxDOTemp$DO_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch12, AmpLuxDOTemp$DO_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch12, AmpLuxDOTemp$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch12","Temp_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch12, AmpLuxDOTemp$Temp_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch12, AmpLuxDOTemp$Temp_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch12, AmpLuxDOTemp$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch13","DO_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch13, AmpLuxDOTemp$DO_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch13, AmpLuxDOTemp$DO_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch13, AmpLuxDOTemp$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch13","Temp_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch13, AmpLuxDOTemp$Temp_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch13, AmpLuxDOTemp$Temp_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch13, AmpLuxDOTemp$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch14","DO_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch14, AmpLuxDOTemp$DO_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch14, AmpLuxDOTemp$DO_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch14, AmpLuxDOTemp$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch14","Temp_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch14, AmpLuxDOTemp$Temp_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch14, AmpLuxDOTemp$Temp_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch14, AmpLuxDOTemp$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch15","DO_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch15, AmpLuxDOTemp$DO_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch15, AmpLuxDOTemp$DO_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch15, AmpLuxDOTemp$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch15","Temp_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch15, AmpLuxDOTemp$Temp_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch15, AmpLuxDOTemp$Temp_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch15, AmpLuxDOTemp$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch16","DO_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch16, AmpLuxDOTemp$DO_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch16, AmpLuxDOTemp$DO_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch16, AmpLuxDOTemp$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("ch16","Temp_70cm","total",sum(complete.cases(AmpLuxDOTemp$ch16, AmpLuxDOTemp$Temp_70cm), na.rm = TRUE), cor(AmpLuxDOTemp$ch16, AmpLuxDOTemp$Temp_70cm, use = "complete.obs"), cor.test(AmpLuxDOTemp$ch16, AmpLuxDOTemp$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("fch1","DO_70cm","total",sum(complete.cases(FirstThird$ch1, FirstThird$DO_70cm), na.rm = TRUE), cor(FirstThird$ch1, FirstThird$DO_70cm, use = "complete.obs"), cor.test(FirstThird$ch1, FirstThird$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("fch1","Temp_70cm","total",sum(complete.cases(FirstThird$ch1, FirstThird$Temp_70cm), na.rm = TRUE), cor(FirstThird$ch1, FirstThird$Temp_70cm, use = "complete.obs"), cor.test(FirstThird$ch1, FirstThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("fch2","DO_70cm","total",sum(complete.cases(FirstThird$ch2, FirstThird$DO_70cm), na.rm = TRUE), cor(FirstThird$ch2, FirstThird$DO_70cm, use = "complete.obs"), cor.test(FirstThird$ch2, FirstThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("fch2","Temp_70cm","total",sum(complete.cases(FirstThird$ch2, FirstThird$Temp_70cm), na.rm = TRUE), cor(FirstThird$ch2, FirstThird$Temp_70cm, use = "complete.obs"), cor.test(FirstThird$ch2, FirstThird$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("fch3","DO_70cm","total",sum(complete.cases(FirstThird$ch3, FirstThird$DO_70cm), na.rm = TRUE), cor(FirstThird$ch3, FirstThird$DO_70cm, use = "complete.obs"), cor.test(FirstThird$ch3, FirstThird$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("fch3","Temp_70cm","total",sum(complete.cases(FirstThird$ch3, FirstThird$Temp_70cm), na.rm = TRUE), cor(FirstThird$ch3, FirstThird$Temp_70cm, use = "complete.obs"), cor.test(FirstThird$ch3, FirstThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("fch4","DO_70cm","total",sum(complete.cases(FirstThird$ch4, FirstThird$DO_70cm), na.rm = TRUE), cor(FirstThird$ch4, FirstThird$DO_70cm, use = "complete.obs"), cor.test(FirstThird$ch4, FirstThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("fch4","Temp_70cm","total",sum(complete.cases(FirstThird$ch4, FirstThird$Temp_70cm), na.rm = TRUE), cor(FirstThird$ch4, FirstThird$Temp_70cm, use = "complete.obs"), cor.test(FirstThird$ch4, FirstThird$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("fch5","DO_70cm","total",sum(complete.cases(FirstThird$ch5, FirstThird$DO_70cm), na.rm = TRUE), cor(FirstThird$ch5, FirstThird$DO_70cm, use = "complete.obs"), cor.test(FirstThird$ch5, FirstThird$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("fch5","Temp_70cm","total",sum(complete.cases(FirstThird$ch5, FirstThird$Temp_70cm), na.rm = TRUE), cor(FirstThird$ch5, FirstThird$Temp_70cm, use = "complete.obs"), cor.test(FirstThird$ch5, FirstThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("fch6","DO_70cm","total",sum(complete.cases(FirstThird$ch6, FirstThird$DO_70cm), na.rm = TRUE), cor(FirstThird$ch6, FirstThird$DO_70cm, use = "complete.obs"), cor.test(FirstThird$ch6, FirstThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("fch6","Temp_70cm","total",sum(complete.cases(FirstThird$ch6, FirstThird$Temp_70cm), na.rm = TRUE), cor(FirstThird$ch6, FirstThird$Temp_70cm, use = "complete.obs"), cor.test(FirstThird$ch6, FirstThird$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("fch7","DO_70cm","total",sum(complete.cases(FirstThird$ch7, FirstThird$DO_70cm), na.rm = TRUE), cor(FirstThird$ch7, FirstThird$DO_70cm, use = "complete.obs"), cor.test(FirstThird$ch7, FirstThird$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("fch7","Temp_70cm","total",sum(complete.cases(FirstThird$ch7, FirstThird$Temp_70cm), na.rm = TRUE), cor(FirstThird$ch7, FirstThird$Temp_70cm, use = "complete.obs"), cor.test(FirstThird$ch7, FirstThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("fch8","DO_70cm","total",sum(complete.cases(FirstThird$ch8, FirstThird$DO_70cm), na.rm = TRUE), cor(FirstThird$ch8, FirstThird$DO_70cm, use = "complete.obs"), cor.test(FirstThird$ch8, FirstThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("fch8","Temp_70cm","total",sum(complete.cases(FirstThird$ch8, FirstThird$Temp_70cm), na.rm = TRUE), cor(FirstThird$ch8, FirstThird$Temp_70cm, use = "complete.obs"), cor.test(FirstThird$ch8, FirstThird$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("fch9","DO_70cm","total",sum(complete.cases(FirstThird$ch9, FirstThird$DO_70cm), na.rm = TRUE), cor(FirstThird$ch9, FirstThird$DO_70cm, use = "complete.obs"), cor.test(FirstThird$ch9, FirstThird$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("fch9","Temp_70cm","total",sum(complete.cases(FirstThird$ch9, FirstThird$Temp_70cm), na.rm = TRUE), cor(FirstThird$ch9, FirstThird$Temp_70cm, use = "complete.obs"), cor.test(FirstThird$ch9, FirstThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("fch10","DO_70cm","total",sum(complete.cases(FirstThird$ch10, FirstThird$DO_70cm), na.rm = TRUE), cor(FirstThird$ch10, FirstThird$DO_70cm, use = "complete.obs"), cor.test(FirstThird$ch10, FirstThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("fch10","Temp_70cm","total",sum(complete.cases(FirstThird$ch10, FirstThird$Temp_70cm), na.rm = TRUE), cor(FirstThird$ch10, FirstThird$Temp_70cm, use = "complete.obs"), cor.test(FirstThird$ch10, FirstThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("fch11","DO_70cm","total",sum(complete.cases(FirstThird$ch11, FirstThird$DO_70cm), na.rm = TRUE), cor(FirstThird$ch11, FirstThird$DO_70cm, use = "complete.obs"), cor.test(FirstThird$ch11, FirstThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("fch11","Temp_70cm","total",sum(complete.cases(FirstThird$ch11, FirstThird$Temp_70cm), na.rm = TRUE), cor(FirstThird$ch11, FirstThird$Temp_70cm, use = "complete.obs"), cor.test(FirstThird$ch11, FirstThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("fch12","DO_70cm","total",sum(complete.cases(FirstThird$ch12, FirstThird$DO_70cm), na.rm = TRUE), cor(FirstThird$ch12, FirstThird$DO_70cm, use = "complete.obs"), cor.test(FirstThird$ch12, FirstThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("fch12","Temp_70cm","total",sum(complete.cases(FirstThird$ch12, FirstThird$Temp_70cm), na.rm = TRUE), cor(FirstThird$ch12, FirstThird$Temp_70cm, use = "complete.obs"), cor.test(FirstThird$ch12, FirstThird$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("fch13","DO_70cm","total",sum(complete.cases(FirstThird$ch13, FirstThird$DO_70cm), na.rm = TRUE), cor(FirstThird$ch13, FirstThird$DO_70cm, use = "complete.obs"), cor.test(FirstThird$ch13, FirstThird$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("fch13","Temp_70cm","total",sum(complete.cases(FirstThird$ch13, FirstThird$Temp_70cm), na.rm = TRUE), cor(FirstThird$ch13, FirstThird$Temp_70cm, use = "complete.obs"), cor.test(FirstThird$ch13, FirstThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("fch14","DO_70cm","total",sum(complete.cases(FirstThird$ch14, FirstThird$DO_70cm), na.rm = TRUE), cor(FirstThird$ch14, FirstThird$DO_70cm, use = "complete.obs"), cor.test(FirstThird$ch14, FirstThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("fch14","Temp_70cm","total",sum(complete.cases(FirstThird$ch14, FirstThird$Temp_70cm), na.rm = TRUE), cor(FirstThird$ch14, FirstThird$Temp_70cm, use = "complete.obs"), cor.test(FirstThird$ch14, FirstThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("fch15","DO_70cm","total",sum(complete.cases(FirstThird$ch15, FirstThird$DO_70cm), na.rm = TRUE), cor(FirstThird$ch15, FirstThird$DO_70cm, use = "complete.obs"), cor.test(FirstThird$ch15, FirstThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("fch15","Temp_70cm","total",sum(complete.cases(FirstThird$ch15, FirstThird$Temp_70cm), na.rm = TRUE), cor(FirstThird$ch15, FirstThird$Temp_70cm, use = "complete.obs"), cor.test(FirstThird$ch15, FirstThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("fch16","DO_70cm","total",sum(complete.cases(FirstThird$ch16, FirstThird$DO_70cm), na.rm = TRUE), cor(FirstThird$ch16, FirstThird$DO_70cm, use = "complete.obs"), cor.test(FirstThird$ch16, FirstThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("fch16","Temp_70cm","total",sum(complete.cases(FirstThird$ch16, FirstThird$Temp_70cm), na.rm = TRUE), cor(FirstThird$ch16, FirstThird$Temp_70cm, use = "complete.obs"), cor.test(FirstThird$ch16, FirstThird$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("mch1","DO_70cm","total",sum(complete.cases(MiddleThird$ch1, MiddleThird$DO_70cm), na.rm = TRUE), cor(MiddleThird$ch1, MiddleThird$DO_70cm, use = "complete.obs"), cor.test(MiddleThird$ch1, MiddleThird$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("mch1","Temp_70cm","total",sum(complete.cases(MiddleThird$ch1, MiddleThird$Temp_70cm), na.rm = TRUE), cor(MiddleThird$ch1, MiddleThird$Temp_70cm, use = "complete.obs"), cor.test(MiddleThird$ch1, MiddleThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("mch2","DO_70cm","total",sum(complete.cases(MiddleThird$ch2, MiddleThird$DO_70cm), na.rm = TRUE), cor(MiddleThird$ch2, MiddleThird$DO_70cm, use = "complete.obs"), cor.test(MiddleThird$ch2, MiddleThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("mch2","Temp_70cm","total",sum(complete.cases(MiddleThird$ch2, MiddleThird$Temp_70cm), na.rm = TRUE), cor(MiddleThird$ch2, MiddleThird$Temp_70cm, use = "complete.obs"), cor.test(MiddleThird$ch2, MiddleThird$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("mch3","DO_70cm","total",sum(complete.cases(MiddleThird$ch3, MiddleThird$DO_70cm), na.rm = TRUE), cor(MiddleThird$ch3, MiddleThird$DO_70cm, use = "complete.obs"), cor.test(MiddleThird$ch3, MiddleThird$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("mch3","Temp_70cm","total",sum(complete.cases(MiddleThird$ch3, MiddleThird$Temp_70cm), na.rm = TRUE), cor(MiddleThird$ch3, MiddleThird$Temp_70cm, use = "complete.obs"), cor.test(MiddleThird$ch3, MiddleThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("mch4","DO_70cm","total",sum(complete.cases(MiddleThird$ch4, MiddleThird$DO_70cm), na.rm = TRUE), cor(MiddleThird$ch4, MiddleThird$DO_70cm, use = "complete.obs"), cor.test(MiddleThird$ch4, MiddleThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("mch4","Temp_70cm","total",sum(complete.cases(MiddleThird$ch4, MiddleThird$Temp_70cm), na.rm = TRUE), cor(MiddleThird$ch4, MiddleThird$Temp_70cm, use = "complete.obs"), cor.test(MiddleThird$ch4, MiddleThird$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("mch5","DO_70cm","total",sum(complete.cases(MiddleThird$ch5, MiddleThird$DO_70cm), na.rm = TRUE), cor(MiddleThird$ch5, MiddleThird$DO_70cm, use = "complete.obs"), cor.test(MiddleThird$ch5, MiddleThird$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("mch5","Temp_70cm","total",sum(complete.cases(MiddleThird$ch5, MiddleThird$Temp_70cm), na.rm = TRUE), cor(MiddleThird$ch5, MiddleThird$Temp_70cm, use = "complete.obs"), cor.test(MiddleThird$ch5, MiddleThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("mch6","DO_70cm","total",sum(complete.cases(MiddleThird$ch6, MiddleThird$DO_70cm), na.rm = TRUE), cor(MiddleThird$ch6, MiddleThird$DO_70cm, use = "complete.obs"), cor.test(MiddleThird$ch6, MiddleThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("mch6","Temp_70cm","total",sum(complete.cases(MiddleThird$ch6, MiddleThird$Temp_70cm), na.rm = TRUE), cor(MiddleThird$ch6, MiddleThird$Temp_70cm, use = "complete.obs"), cor.test(MiddleThird$ch6, MiddleThird$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("mch7","DO_70cm","total",sum(complete.cases(MiddleThird$ch7, MiddleThird$DO_70cm), na.rm = TRUE), cor(MiddleThird$ch7, MiddleThird$DO_70cm, use = "complete.obs"), cor.test(MiddleThird$ch7, MiddleThird$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("mch7","Temp_70cm","total",sum(complete.cases(MiddleThird$ch7, MiddleThird$Temp_70cm), na.rm = TRUE), cor(MiddleThird$ch7, MiddleThird$Temp_70cm, use = "complete.obs"), cor.test(MiddleThird$ch7, MiddleThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("mch8","DO_70cm","total",sum(complete.cases(MiddleThird$ch8, MiddleThird$DO_70cm), na.rm = TRUE), cor(MiddleThird$ch8, MiddleThird$DO_70cm, use = "complete.obs"), cor.test(MiddleThird$ch8, MiddleThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("mch8","Temp_70cm","total",sum(complete.cases(MiddleThird$ch8, MiddleThird$Temp_70cm), na.rm = TRUE), cor(MiddleThird$ch8, MiddleThird$Temp_70cm, use = "complete.obs"), cor.test(MiddleThird$ch8, MiddleThird$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("mch9","DO_70cm","total",sum(complete.cases(MiddleThird$ch9, MiddleThird$DO_70cm), na.rm = TRUE), cor(MiddleThird$ch9, MiddleThird$DO_70cm, use = "complete.obs"), cor.test(MiddleThird$ch9, MiddleThird$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("mch9","Temp_70cm","total",sum(complete.cases(MiddleThird$ch9, MiddleThird$Temp_70cm), na.rm = TRUE), cor(MiddleThird$ch9, MiddleThird$Temp_70cm, use = "complete.obs"), cor.test(MiddleThird$ch9, MiddleThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("mch10","DO_70cm","total",sum(complete.cases(MiddleThird$ch10, MiddleThird$DO_70cm), na.rm = TRUE), cor(MiddleThird$ch10, MiddleThird$DO_70cm, use = "complete.obs"), cor.test(MiddleThird$ch10, MiddleThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("mch10","Temp_70cm","total",sum(complete.cases(MiddleThird$ch10, MiddleThird$Temp_70cm), na.rm = TRUE), cor(MiddleThird$ch10, MiddleThird$Temp_70cm, use = "complete.obs"), cor.test(MiddleThird$ch10, MiddleThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("mch11","DO_70cm","total",sum(complete.cases(MiddleThird$ch11, MiddleThird$DO_70cm), na.rm = TRUE), cor(MiddleThird$ch11, MiddleThird$DO_70cm, use = "complete.obs"), cor.test(MiddleThird$ch11, MiddleThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("mch11","Temp_70cm","total",sum(complete.cases(MiddleThird$ch11, MiddleThird$Temp_70cm), na.rm = TRUE), cor(MiddleThird$ch11, MiddleThird$Temp_70cm, use = "complete.obs"), cor.test(MiddleThird$ch11, MiddleThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("mch12","DO_70cm","total",sum(complete.cases(MiddleThird$ch12, MiddleThird$DO_70cm), na.rm = TRUE), cor(MiddleThird$ch12, MiddleThird$DO_70cm, use = "complete.obs"), cor.test(MiddleThird$ch12, MiddleThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("mch12","Temp_70cm","total",sum(complete.cases(MiddleThird$ch12, MiddleThird$Temp_70cm), na.rm = TRUE), cor(MiddleThird$ch12, MiddleThird$Temp_70cm, use = "complete.obs"), cor.test(MiddleThird$ch12, MiddleThird$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("mch13","DO_70cm","total",sum(complete.cases(MiddleThird$ch13, MiddleThird$DO_70cm), na.rm = TRUE), cor(MiddleThird$ch13, MiddleThird$DO_70cm, use = "complete.obs"), cor.test(MiddleThird$ch13, MiddleThird$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("mch13","Temp_70cm","total",sum(complete.cases(MiddleThird$ch13, MiddleThird$Temp_70cm), na.rm = TRUE), cor(MiddleThird$ch13, MiddleThird$Temp_70cm, use = "complete.obs"), cor.test(MiddleThird$ch13, MiddleThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("mch14","DO_70cm","total",sum(complete.cases(MiddleThird$ch14, MiddleThird$DO_70cm), na.rm = TRUE), cor(MiddleThird$ch14, MiddleThird$DO_70cm, use = "complete.obs"), cor.test(MiddleThird$ch14, MiddleThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("mch14","Temp_70cm","total",sum(complete.cases(MiddleThird$ch14, MiddleThird$Temp_70cm), na.rm = TRUE), cor(MiddleThird$ch14, MiddleThird$Temp_70cm, use = "complete.obs"), cor.test(MiddleThird$ch14, MiddleThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("mch15","DO_70cm","total",sum(complete.cases(MiddleThird$ch15, MiddleThird$DO_70cm), na.rm = TRUE), cor(MiddleThird$ch15, MiddleThird$DO_70cm, use = "complete.obs"), cor.test(MiddleThird$ch15, MiddleThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("mch15","Temp_70cm","total",sum(complete.cases(MiddleThird$ch15, MiddleThird$Temp_70cm), na.rm = TRUE), cor(MiddleThird$ch15, MiddleThird$Temp_70cm, use = "complete.obs"), cor.test(MiddleThird$ch15, MiddleThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("mch16","DO_70cm","total",sum(complete.cases(MiddleThird$ch16, MiddleThird$DO_70cm), na.rm = TRUE), cor(MiddleThird$ch16, MiddleThird$DO_70cm, use = "complete.obs"), cor.test(MiddleThird$ch16, MiddleThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("mch16","Temp_70cm","total",sum(complete.cases(MiddleThird$ch16, MiddleThird$Temp_70cm), na.rm = TRUE), cor(MiddleThird$ch16, MiddleThird$Temp_70cm, use = "complete.obs"), cor.test(MiddleThird$ch16, MiddleThird$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("lch1","DO_70cm","total",sum(complete.cases(LastThird$ch1, LastThird$DO_70cm), na.rm = TRUE), cor(LastThird$ch1, LastThird$DO_70cm, use = "complete.obs"), cor.test(LastThird$ch1, LastThird$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("lch1","Temp_70cm","total",sum(complete.cases(LastThird$ch1, LastThird$Temp_70cm), na.rm = TRUE), cor(LastThird$ch1, LastThird$Temp_70cm, use = "complete.obs"), cor.test(LastThird$ch1, LastThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("lch2","DO_70cm","total",sum(complete.cases(LastThird$ch2, LastThird$DO_70cm), na.rm = TRUE), cor(LastThird$ch2, LastThird$DO_70cm, use = "complete.obs"), cor.test(LastThird$ch2, LastThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("lch2","Temp_70cm","total",sum(complete.cases(LastThird$ch2, LastThird$Temp_70cm), na.rm = TRUE), cor(LastThird$ch2, LastThird$Temp_70cm, use = "complete.obs"), cor.test(LastThird$ch2, LastThird$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("lch3","DO_70cm","total",sum(complete.cases(LastThird$ch3, LastThird$DO_70cm), na.rm = TRUE), cor(LastThird$ch3, LastThird$DO_70cm, use = "complete.obs"), cor.test(LastThird$ch3, LastThird$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("lch3","Temp_70cm","total",sum(complete.cases(LastThird$ch3, LastThird$Temp_70cm), na.rm = TRUE), cor(LastThird$ch3, LastThird$Temp_70cm, use = "complete.obs"), cor.test(LastThird$ch3, LastThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("lch4","DO_70cm","total",sum(complete.cases(LastThird$ch4, LastThird$DO_70cm), na.rm = TRUE), cor(LastThird$ch4, LastThird$DO_70cm, use = "complete.obs"), cor.test(LastThird$ch4, LastThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("lch4","Temp_70cm","total",sum(complete.cases(LastThird$ch4, LastThird$Temp_70cm), na.rm = TRUE), cor(LastThird$ch4, LastThird$Temp_70cm, use = "complete.obs"), cor.test(LastThird$ch4, LastThird$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("lch5","DO_70cm","total",sum(complete.cases(LastThird$ch5, LastThird$DO_70cm), na.rm = TRUE), cor(LastThird$ch5, LastThird$DO_70cm, use = "complete.obs"), cor.test(LastThird$ch5, LastThird$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("lch5","Temp_70cm","total",sum(complete.cases(LastThird$ch5, LastThird$Temp_70cm), na.rm = TRUE), cor(LastThird$ch5, LastThird$Temp_70cm, use = "complete.obs"), cor.test(LastThird$ch5, LastThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("lch6","DO_70cm","total",sum(complete.cases(LastThird$ch6, LastThird$DO_70cm), na.rm = TRUE), cor(LastThird$ch6, LastThird$DO_70cm, use = "complete.obs"), cor.test(LastThird$ch6, LastThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("lch6","Temp_70cm","total",sum(complete.cases(LastThird$ch6, LastThird$Temp_70cm), na.rm = TRUE), cor(LastThird$ch6, LastThird$Temp_70cm, use = "complete.obs"), cor.test(LastThird$ch6, LastThird$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("lch7","DO_70cm","total",sum(complete.cases(LastThird$ch7, LastThird$DO_70cm), na.rm = TRUE), cor(LastThird$ch7, LastThird$DO_70cm, use = "complete.obs"), cor.test(LastThird$ch7, LastThird$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("lch7","Temp_70cm","total",sum(complete.cases(LastThird$ch7, LastThird$Temp_70cm), na.rm = TRUE), cor(LastThird$ch7, LastThird$Temp_70cm, use = "complete.obs"), cor.test(LastThird$ch7, LastThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("lch8","DO_70cm","total",sum(complete.cases(LastThird$ch8, LastThird$DO_70cm), na.rm = TRUE), cor(LastThird$ch8, LastThird$DO_70cm, use = "complete.obs"), cor.test(LastThird$ch8, LastThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("lch8","Temp_70cm","total",sum(complete.cases(LastThird$ch8, LastThird$Temp_70cm), na.rm = TRUE), cor(LastThird$ch8, LastThird$Temp_70cm, use = "complete.obs"), cor.test(LastThird$ch8, LastThird$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("lch9","DO_70cm","total",sum(complete.cases(LastThird$ch9, LastThird$DO_70cm), na.rm = TRUE), cor(LastThird$ch9, LastThird$DO_70cm, use = "complete.obs"), cor.test(LastThird$ch9, LastThird$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("lch9","Temp_70cm","total",sum(complete.cases(LastThird$ch9, LastThird$Temp_70cm), na.rm = TRUE), cor(LastThird$ch9, LastThird$Temp_70cm, use = "complete.obs"), cor.test(LastThird$ch9, LastThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("lch10","DO_70cm","total",sum(complete.cases(LastThird$ch10, LastThird$DO_70cm), na.rm = TRUE), cor(LastThird$ch10, LastThird$DO_70cm, use = "complete.obs"), cor.test(LastThird$ch10, LastThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("lch10","Temp_70cm","total",sum(complete.cases(LastThird$ch10, LastThird$Temp_70cm), na.rm = TRUE), cor(LastThird$ch10, LastThird$Temp_70cm, use = "complete.obs"), cor.test(LastThird$ch10, LastThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("lch11","DO_70cm","total",sum(complete.cases(LastThird$ch11, LastThird$DO_70cm), na.rm = TRUE), cor(LastThird$ch11, LastThird$DO_70cm, use = "complete.obs"), cor.test(LastThird$ch11, LastThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("lch11","Temp_70cm","total",sum(complete.cases(LastThird$ch11, LastThird$Temp_70cm), na.rm = TRUE), cor(LastThird$ch11, LastThird$Temp_70cm, use = "complete.obs"), cor.test(LastThird$ch11, LastThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("lch12","DO_70cm","total",sum(complete.cases(LastThird$ch12, LastThird$DO_70cm), na.rm = TRUE), cor(LastThird$ch12, LastThird$DO_70cm, use = "complete.obs"), cor.test(LastThird$ch12, LastThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("lch12","Temp_70cm","total",sum(complete.cases(LastThird$ch12, LastThird$Temp_70cm), na.rm = TRUE), cor(LastThird$ch12, LastThird$Temp_70cm, use = "complete.obs"), cor.test(LastThird$ch12, LastThird$Temp_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("lch13","DO_70cm","total",sum(complete.cases(LastThird$ch13, LastThird$DO_70cm), na.rm = TRUE), cor(LastThird$ch13, LastThird$DO_70cm, use = "complete.obs"), cor.test(LastThird$ch13, LastThird$DO_70cm, use = "complete.obs")$p.value)
...
#Heatmap[nrow(Heatmap) + 1,] = c("lch13","Temp_70cm","total",sum(complete.cases(LastThird$ch13, LastThird$Temp_70cm), na.rm = TRUE), cor(LastThird$ch13, LastThird$Temp_70cm, use = "complete.obs"), cor.test(LastThird$ch13, LastThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("lch14","DO_70cm","total",sum(complete.cases(LastThird$ch14, LastThird$DO_70cm), na.rm = TRUE), cor(LastThird$ch14, LastThird$DO_70cm, use = "complete.obs"), cor.test(LastThird$ch14, LastThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("lch14","Temp_70cm","total",sum(complete.cases(LastThird$ch14, LastThird$Temp_70cm), na.rm = TRUE), cor(LastThird$ch14, LastThird$Temp_70cm, use = "complete.obs"), cor.test(LastThird$ch14, LastThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("lch15","DO_70cm","total",sum(complete.cases(LastThird$ch15, LastThird$DO_70cm), na.rm = TRUE), cor(LastThird$ch15, LastThird$DO_70cm, use = "complete.obs"), cor.test(LastThird$ch15, LastThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("lch15","Temp_70cm","total",sum(complete.cases(LastThird$ch15, LastThird$Temp_70cm), na.rm = TRUE), cor(LastThird$ch15, LastThird$Temp_70cm, use = "complete.obs"), cor.test(LastThird$ch15, LastThird$Temp_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("lch16","DO_70cm","total",sum(complete.cases(LastThird$ch16, LastThird$DO_70cm), na.rm = TRUE), cor(LastThird$ch16, LastThird$DO_70cm, use = "complete.obs"), cor.test(LastThird$ch16, LastThird$DO_70cm, use = "complete.obs")$p.value)
...
Heatmap[nrow(Heatmap) + 1,] = c("lch16","Temp_70cm","total",sum(complete.cases(LastThird$ch16, LastThird$Temp_70cm), na.rm = TRUE), cor(LastThird$ch16, LastThird$Temp_70cm, use = "complete.obs"), cor.test(LastThird$ch16, LastThird$Temp_70cm, use = "complete.obs")$p.value)
