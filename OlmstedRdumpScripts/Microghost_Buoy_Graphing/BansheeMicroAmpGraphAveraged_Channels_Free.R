...
#different cathode = greenish , membrane = blueish, deeper anode = darker
cbPalette <- c("gold1","gold4","red","mediumvioletred","magenta4","chartreuse1","sienna3","orangered4","chartreuse3","chartreuse4")
colScale2 <- scale_colour_manual(values=cbPalette)

#removing membrane channels
geist <- geist[,c(1,3,5,7,9,11,12,13,15,16,17)]
...
ggsave(filename = "Microgeist_Graphs/BanAll_2019-08-04_to_2019-08-06", plot = last_plot(), device = "pdf", width = 13, height = 7.5, units = "in")
