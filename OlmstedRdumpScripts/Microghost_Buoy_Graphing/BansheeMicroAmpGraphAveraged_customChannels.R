...
cbPalette <- c("gold1","gold4","red","mediumvioletred","magenta4","sienna3","orangered4")
colScale2 <- scale_colour_manual(values=cbPalette)

#removing membrane channels and other unwanted channels, desired: Ch2, Ch4, Ch6, Ch8, Ch10, Ch12, Ch14
geist <- geist[,c(1,3,5,7,9,11,13,15)]
...
ggsave(filename = "Microgeist_Graphs/BanCustom_2019-08-04_to_2019-08-06", plot = last_plot(), device = "pdf", width = 13, height = 7.5, units = "in")
