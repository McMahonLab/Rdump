...
cbPalette <- c("chartreuse1","orangered4","magenta4")
colScale2 <- scale_colour_manual(values=cbPalette)

#removing membrane channels and other unwanted channels, desired: Ch2, Ch10, Ch14
geist <- geist[,c(1,5,11,15)]
...
ggsave(filename = "Microgeist_Graphs/SpeCus4_2019-08-04_to_2019-08-06", plot = last_plot(), device = "pdf", width = 13, height = 7.5, units = "in")
